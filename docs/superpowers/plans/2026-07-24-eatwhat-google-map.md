...
- [ ] **Step 3: Keep the fallback interface aligned**
...
- [ ] **Step 1: Add environment placeholders and ignore rules**

Track only `.env.example`; ignore real `.env` and `.env.*` files.

- [ ] **Step 2: Add dynamic Expo config**
...
- [ ] **Step 3: Validate public Expo config**
